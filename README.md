This project link for the [Demo App](https://hamburgueria-75c22.firebaseapp.com/app).
...
- [Installing with create-app-react boilerplate](#Installing Boilerplate)
- [Ejecting Project To Scopped Css Files](#EjectingProject)
...
```
npx  create-react-app hamburgueria --use-npm --scripts-version=1.0.14
```

## Ejecting Project To Scopped Css Files
